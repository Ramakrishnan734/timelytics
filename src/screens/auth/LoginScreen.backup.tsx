...
const LoginScreen: React.FC = () => {
  ...
  const handleLogin = async () => {
    ...
    try {
      ...
      console.log('[LOGIN-DIAG] LoginScreen catch — err.code:', err?.code, '| err.message:', err?.message, '| err.name:', err?.name);
      const msg = getAuthErrorMessage(err);
      console.log('[LOGIN-DIAG] LoginScreen catch — getAuthErrorMessage returned:', msg);
      setApiError(msg);
    } finally {
      setLoading(false);
    }
